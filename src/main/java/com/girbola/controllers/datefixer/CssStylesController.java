...
public class CssStylesController {
    ...
    //@formatter:off
	public static String getBad_style() { return bad_style; }
	public static String getConfirmed_style() { return confirmed_style; }
	public static String getGood_style() { return good_style; }
	public static String getModified_style() { return modified_style; }
	public static String getSuggested_style() { return suggested_style; }
	public static String getVideo_style() {	return video_style;	}
