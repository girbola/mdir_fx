...
public class CheckFolderInfoForChanges extends Task<Boolean> {
	...
	public CheckFolderInfoForChanges(FolderInfo folderInfo, TableView<FolderInfo> tableView, LoadingProcess_Task loadingProcess) {
		super();
	...
	class GetFolderList implements Callable<List<Path>> {
		...
		public List<Path> call() throws Exception {
			...
			try {
				...
				Messages.sprintf("Getting folderInfo folder list size is: " + list.size());
