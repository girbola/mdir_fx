...
public class VLCPlayerController {
	...
	@FXML private Canvas vlc_canvas;
	@FXML private Slider volume_slider;
	@FXML private Slider slider;
	@FXML private Button play_btn;
	@FXML private Button skip_back_btn;
	@FXML private Button stop_btn;
	@FXML private Button skip_forward_btn;
	@FXML private ToggleButton mute_btn;
	@FXML private ToggleButton fullScreen_btn;
	@FXML void play_btn_action(ActionEvent event) {
