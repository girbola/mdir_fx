...
public class DatesTreeTableViewController {
	...
	public void init(Model_main model_main) {
		...
		folders_ttc.setCellValueFactory(
				new Callback<TreeTableColumn.CellDataFeatures<TreeFolderInfo, String>, ObservableValue<String>>() {
		...
		rootMonth_ttc.setCellValueFactory(
				new Callback<TreeTableColumn.CellDataFeatures<TreeFolderInfo, String>, ObservableValue<String>>() {
		...
		dayMonth_ttc.setCellValueFactory(
				new Callback<TreeTableColumn.CellDataFeatures<TreeFolderInfo, String>, ObservableValue<String>>() {
		...
		possibleEvents_ttc.setCellValueFactory(
				new Callback<TreeTableColumn.CellDataFeatures<TreeFolderInfo, String>, ObservableValue<String>>() {
